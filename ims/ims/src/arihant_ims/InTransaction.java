...
public class InTransaction extends javax.swing.JDialog {
    ...
    public InTransaction(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        conn = arihant_ims.CreateConnection.connectDB();
        initComponents();
    ...
    private void fill_table() {
        try {
            pst = conn.prepareStatement("SELECT * FROM transactionsIN order by transactionId desc limit 40");
            rs = pst.executeQuery();
            Table.setModel(arihant_ims.C.getModel(rs));
        } catch (SQLException ex) {
    ...
    private void initComponents() {
        ...
        TextRawMaterial = new javax.swing.JTextField();
        ...
        PanelToolsLayout.setHorizontalGroup(
            ...
            .addComponent(ButtonRefresh, javax.swing.GroupLayout.DEFAULT_SIZE, 185, Short.MAX_VALUE)
        ...
        LabelMaterialName.setText("<html><h2>Raw<br>    Material");
        ...
        ComboBoxRaw.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select Raw Material" }));
        ComboBoxRaw.setEnabled(false);
        ComboBoxRaw.setNextFocusableComponent(TextQuantity);
        ...
        TextQuantity.setNextFocusableComponent(TextPrice);
        ...
        TextPrice.setNextFocusableComponent(ComboBoxPackingType);

        ButtonAddItem.setText("<html><h1>Add <br>Item");
        ...
        jLabel7.setText("<html><h2>Packaging Type");
        ...
        ComboBoxPackingType.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select Packaging Type" }));
        ...
        TextRawMaterial.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        TextRawMaterial.setEnabled(false);
        TextRawMaterial.setNextFocusableComponent(TextQuantity);
        TextRawMaterial.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TextRawMaterialActionPerformed(evt);
            }
        });
        ...
        jRadioButton6.setText("EXISTING");
        ...
        jRadioButton7.setText("Finished Goods");
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addGap(58, 58, 58)
                .addComponent(ButtonDeleteItem, javax.swing.GroupLayout.PREFERRED_SIZE, 253, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(ComboBoxPackingType, javax.swing.GroupLayout.PREFERRED_SIZE, 187, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(TextPackingQuantity, javax.swing.GroupLayout.PREFERRED_SIZE, 187, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(TextPrice, javax.swing.GroupLayout.PREFERRED_SIZE, 187, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(ButtonAddItem, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel5Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addGroup(jPanel5Layout.createSequentialGroup()
                                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(LabelMaterialName, javax.swing.GroupLayout.PREFERRED_SIZE, 78, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGap(31, 31, 31)
                                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(ComboBoxRaw, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                            .addComponent(TextRawMaterial, javax.swing.GroupLayout.PREFERRED_SIZE, 185, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(TextQuantity, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 186, javax.swing.GroupLayout.PREFERRED_SIZE))))
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addGap(8, 8, 8)
                                .addComponent(TextRawMaterial, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(4, 4, 4))
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                .addComponent(LabelMaterialName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(TextQuantity, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addComponent(ButtonAddItem, javax.swing.GroupLayout.PREFERRED_SIZE, 67, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(90, 90, 90)))
                .addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(ButtonDeleteItem, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(85, 85, 85))
        );
        ...
        jLabel5.setText("<html><h2>Party<br> Name");
        ...
        ComboBoxParty.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select Supplier Name" }));
        ...
        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Comments (If any)", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 10), new java.awt.Color(51, 102, 255))); // NOI18N
        ...
        jPanel7.getAccessibleContext().setAccessibleName("Commets");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(TextStartDate, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(37, 37, 37)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(jLabel6, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(DateChooserEnd, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(TextStartDate, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(jButton3, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 191, Short.MAX_VALUE))
    ...
    private void TableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableMouseClicked
        ...
        String sql = "select * from transactionsIN where transactionId='" + rowIdStr + "'";
        try {
...
//   TextDate.setText(dateNow1);   
    ...
    public void comboBoxPackingTypeNameFiller() {
        ComboBoxPackingType.removeAllItems();
        ComboBoxPackingType.addItem("Select Packaging Type");
        try {
    ...
    public void comboBoxPartyNameFiller() {
        if (jRadioButton4.isSelected() == true) {
            ...
            ComboBoxParty.removeAllItems();
            ComboBoxParty.addItem("Select Customer Name");
            try {
        ...
        if (jRadioButton1.isSelected() == true) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    } else if (rs.getString("itemName").equals("")) {
                    } else {
            ...
            jRadioButton2.setEnabled(false);
            TextRawMaterial.setEnabled(false);
            LabelMaterialName.setText("<html><h2>Packing<br>Material");
            ComboBoxRaw.removeAllItems();
            ...
            jRadioButton2.setEnabled(false);
            TextRawMaterial.setEnabled(false);
            LabelMaterialName.setText("<html><h2>Finished<br>Goods");
            ComboBoxRaw.removeAllItems();
    ...
    public void rawMaterialfiller() {
        if (jRadioButton6.isSelected() == true) {
            ComboBoxRaw.setEnabled(true);
            TextRawMaterial.setEnabled(false);
        } else {
            TextRawMaterial.setEnabled(true);
            ComboBoxRaw.setEnabled(false);
        }
    }
    ...
    public int negativeStockCheckOnDelete() {


        String sql;

        String strItemName = ComboBoxRaw.getSelectedItem().toString();
        String strQuantity = TextQuantity.getText();
        String strPrice = TextPrice.getText();
        String strPackingType = ComboBoxPackingType.getSelectedItem().toString();
        String strPackingQuantity = TextPackingQuantity.getText();
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (openingStock < quantityNeeded) {
                    return 1;
                    //PaneLabel = "Enter quantity less than or equal to " + openingStock + " for " + strItemName;
                }
            }
        } catch (SQLException ex) {
...
// System.out.println(sql);
    ...
    private void ButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonDeleteActionPerformed
        if (click.equals("readyForEdit")) {
            ...
            // System.out.print(i);
            int negativeStock;
            negativeStock = negativeStockCheckOnDelete();
            if (negativeStock == 1) {
                JOptionPane.showMessageDialog(null, "Deleting this item will make stock negative");
            } else if (i == 0) {
                click = "";
                String sql = "delete from transactionsIN  where transactionId='" + rowIdStr + "'";
                deletion(sql);

                //System.out.println(sqlQuerry);
                sqlQuerry = " update RawMaterials  set  openingStock = openingStock - " + TextQuantity.getText() + " where itemName = '" + ComboBoxRaw.getSelectedItem() + "' or itemAlias = '" + ComboBoxRaw.getSelectedItem() + "'";
                updationInFinishedGoodsTable(sqlQuerry);
                sqlQuerry = " update FinishedGoods  set  openingStock = openingStock - " + TextQuantity.getText() + " where itemName = '" + ComboBoxRaw.getSelectedItem() + "' or itemAlias = '" + ComboBoxRaw.getSelectedItem() + "'";
                updationInFinishedGoodsTable(sqlQuerry);
                //System.out.println(sqlQuerry);
                //pdation in packing table
...
// TODO add your handling code here:
    ...
    public String getPrice(String strItemName, String price, String date) {

        String returnPrice = "";

        String sql = "select * from transactionsIN where item = '" + strItemName + "' and tdate > '" + date + "'";
    ...
    public void updatePrice(String itemName, String price) {
        String sql = " update RawMaterials set cost = round(" + price + ",2) where itemName = '" + itemName + "'or itemAlias = '" + itemName + "'";
        // System.out.print(sql);
        try {
...
//        sql = " update FinishedGoods set cost = " + price + " where itemName = '" + itemName + "'or itemAlias = '" + itemName + "'";
//        //System.out.print(sql);
//        try {
...
//update price
                    ...
                    String returnprice = getPrice(strItemName, strPrice, strDate);

                    if ((returnprice.equals(" "))) {
                        //System.out.print("updation not required");
                    } else {
                        //System.out.print("updation required");
                        updatePrice(strItemName, strPrice);
                    }
                    ...
                    try {
                        Statement stmraw = null;
                        ResultSet rsraw = null;
                        stmraw = conn.createStatement();
                        rsraw = stmraw.executeQuery(sql);
                        strItemName = rsraw.getObject(1).toString();
                        stmraw.close();
                        rsraw.close();
                    } catch (Exception e) {
                    }
                    ...
                    try {
                        ...
                        Statement stmfin = null;
                        stmfin = conn.createStatement();
                        rsfin = stmfin.executeQuery(sql);
                        strItemName = rsfin.getObject(1).toString();
                        rsfin.close();
                        stmfin.close();
...
//update packing
                    ...
                    sql = "Insert into transactionsIN values( '"
                            + get_id() + "','"
                            + strDate + "','" + strItemName + "',round('" + strQuantity + "',2),round('"
...
//for party name
        if (jRadioButton3.isSelected() == true) {
            if (TextPartyName.getText().equals("")) {
                ...
                if (PaneLabel.equals("")) {
                    PaneLabel = arihant_ims.Validation.primaryKeyChk(TextPartyName.getText(), "name", "Customers");
                }
            }
        } else {
            ...
            if (ComboBoxParty.getSelectedItem().equals("Select Customer Name")) {
                PaneLabel = "Please select Customer Name";
            }
    ...
    private String get_id() {
        ...
        try {
            ...
            rs = stm.executeQuery("select max(transactionId) from transactionsIN");
...
//System.out.println(sql);
            try {
                ...
                Logger.getLogger(InTransaction.class.getName()).log(Level.SEVERE,
                        null, ex);
            } finally {
                try {
                    pst.close();
...
// System.out.println(sql);
            try {
                ...
                rs = pst.executeQuery();
                if (rs.next()) {
                    String strOpeningStock = rs.getString("openingStock");
                    int openingStock = Integer.valueOf(strOpeningStock);
                    int quantityNeeded = Integer.valueOf(strQuantity);
                    if (openingStock < quantityNeeded) {
                        PaneLabel = "Enter quantity less than or equal to " + openingStock + " for " + strItemName;
    ...
    private void ButtonAddItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonAddItemActionPerformed
        ...
        if (jRadioButton1.isSelected() == true) {
            if (jRadioButton2.isSelected() == true) {
                rawMaterial = TextRawMaterial.getText();
            } else {
                rawMaterial = ComboBoxRaw.getSelectedItem().toString();
            }
        }
        ...
        if (rawMaterial.equals("Select Finished Goods")) {
            JOptionPane.showMessageDialog(null, "Please select finished goods");
        } else if (rawMaterial.equals("Select Raw Material")) {
            JOptionPane.showMessageDialog(null, "Please select raw material");
        } else if (!(arihant_ims.Validation.qtyChk(quantity)).equals("")) {
            JOptionPane.showMessageDialog(null, arihant_ims.Validation.qtyChk(quantity));
        } else if (!(arihant_ims.Validation.priceChk(price)).equals("")) {
            JOptionPane.showMessageDialog(null, arihant_ims.Validation.priceChk(price));
        } else if (!(arihant_ims.Validation.qtyChk(packingQuantity)).equals("")) {
            JOptionPane.showMessageDialog(null, "Enter valid packing quantity");
        } else if (packingType.equals("Select Packaging Type")) {
            JOptionPane.showMessageDialog(null, "Please select Packaging Type");
        } else if (rawMaterial.equals("")) {
            JOptionPane.showMessageDialog(null, "Please write raw material");
        } else {
            while (count < row) {
// code to check if item already exists
//                if (rawMaterial.equals(TableItem.getValueAt(count, 0))) {
...
//                }
            ...
            if (chk) {
                if (jRadioButton1.isSelected() == true) {
                    ...
                    if (jRadioButton2.isSelected() == true) {
                        String sql = " Insert into RawMaterials values( '"
                                + rawMaterial + "',round('" + price + "',2),'0','0','','','0')";
                        try {
                            Statement stm = conn.createStatement();
                            stm.executeUpdate(sql);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        CreateConnection.DeleteAll("transactionsIN", conn);        // TODO add your handling code here:
    ...
    private void TextRawMaterialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TextRawMaterialActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TextRawMaterialActionPerformed

    private void jRadiobutton2(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jRadiobutton2
        rawMaterialfiller();    // TODO add your handling code here:
    }//GEN-LAST:event_jRadiobutton2

    private void jradiobutton6(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jradiobutton6
        rawMaterialfiller();        // TODO add your handling code here:
    }//GEN-LAST:event_jradiobutton6
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (TextStartDate.getText().equals("")) {
            ...
            try {
                ...
                String sql = "Select *  from transactionsIN where tdate between'" + TextStartDate.getText() + "' and '" + TextEndDate.getText() + "'";
 ...
 int a = evt.getKeyCode();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InTransaction.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                InTransaction dialog = new InTransaction(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTextField TextRawMaterial;
