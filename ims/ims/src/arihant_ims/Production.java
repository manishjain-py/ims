...
public class Production extends javax.swing.JDialog {
     ...
     */
    public Production(java.awt.Frame parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(ComboCustomRecipee, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//        JOptionPane.showMessageDialog(null, recipeName);
    ...
    private void Btn_AddItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_AddItemActionPerformed
        ...
        for (int i = 0; i < 1; i++) {
            ...
            if (chk) {
                ...
                ratioDouble = Production.RoundTo2Decimals(ratioDouble);
    ...
    private void ButtonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonEditActionPerformed
        ...
        if (Table.getSelectedRow() == -1 || Table.getSelectedRow() >= row) {
            ...
            if (rat == null) {
                ...
                Double rat1 = Production.RoundTo2Decimals(Double.parseDouble(rat));
    ...
    private void btnGoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGoActionPerformed
        try {
            ...
            new_batch = Production.RoundTo2Decimals(new_batch);
            Double new_batch1 = Production.RoundTo2Decimals(new_batch);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                final Production dialog = new Production(new javax.swing.JFrame(), true);
                dialog.addWindowListener(new java.awt.event.WindowAdapter() {
                    ...
                    public void windowClosing(java.awt.event.WindowEvent e) {
                        try {
                            ...
                            Logger.getLogger(Production.class.getName()).log(Level.SEVERE, null, sqle);
                        }
                        System.exit(0);
                    }
                });
