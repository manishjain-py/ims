...
public class RawMaterials1 extends javax.swing.JDialog {
     ...
     */
    public RawMaterials1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void fill_table() {
        try {
            pst = conn.prepareStatement("select itemName as 'Item Name', itemAlias as 'Alias', cost as 'Cost per unit(Rs.)',reorder as 'Reorder quantity(kg)',openingStock as 'Opening Stock(kg)',narration as Narration from RawMaterials");
            rs = pst.executeQuery();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "SEARCH", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial Black", 1, 20), new java.awt.Color(51, 51, 255))); // NOI18N

        TextSearch.setFont(new java.awt.Font("Arial Black", 0, 18)); // NOI18N
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "CONTROLS", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial Black", 1, 20), new java.awt.Color(51, 51, 255))); // NOI18N

        ButtonAdd.setText("ADD NEW ITEM");
        ButtonAdd.setMaximumSize(new java.awt.Dimension(125, 25));
        ButtonAdd.setMinimumSize(new java.awt.Dimension(125, 25));
        ButtonAdd.setPreferredSize(new java.awt.Dimension(125, 25));
        ...
        ButtonEdit.setText("EDIT THIS ITEM");
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, ButtonAdd, org.jdesktop.beansbinding.ObjectProperty.create(), ButtonDelete, org.jdesktop.beansbinding.BeanProperty.create("preferredSize"));
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, ButtonAdd, org.jdesktop.beansbinding.ObjectProperty.create(), ButtonClear, org.jdesktop.beansbinding.BeanProperty.create("preferredSize"));
        bindingGroup.addBinding(binding);
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, ButtonAdd, org.jdesktop.beansbinding.ELProperty.create("${maximumSize.height}"), ButtonRefresh, org.jdesktop.beansbinding.BeanProperty.create("maximumSize"));
        bindingGroup.addBinding(binding);
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "EDITOR", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 24), new java.awt.Color(0, 0, 255))); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(TextCost, javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void TableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableMouseClicked
        ...
        try {
            ...
            if (rs.next()) {
                ...
                TextOpening.setText(rs.getString("openingStock"));
...
if(TextSearch.getText().equals("")){
        ...
        try {
            pst = conn.prepareStatement("select * from RawMaterials where itemName='" + TextSearch.getText() + "' or itemAlias='" +TextSearch.getText()+"'");
            rs = pst.executeQuery();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (click.equals("edit")) {
            if (TextName.isEnabled() == true && TextCost.isEnabled() == true && TextReorder.isEnabled() == true && TextOpening.isEnabled() == true) {
                ...
                if (PaneLabel.equals("")) {
                    String sql = "Update RawMaterials set itemName='" + TextName.getText() + "',itemAlias='" + TextAlias.getText() +"',cost='" + TextCost.getText() + "',reorder='" + TextReorder.getText() + "',openingStock='" + TextOpening.getText() + "',narration='" + TextNarration.getText() + "',initialStock='" + TextOpening.getText() + "' where itemName='" + editItem + "'";
                    try {
            ...
            if (TextName.isEnabled() == true && TextCost.isEnabled() == true && TextReorder.isEnabled() == true && TextOpening.isEnabled() == true) {
                ...
                if (PaneLabel.equals("")) {
                    String sql = "Insert into RawMaterials values( '" + TextName.getText() + "','" + TextCost.getText() + "','" + TextReorder.getText() + "','" + TextOpening.getText()+"','"+ TextAlias.getText()+"','"+ TextNarration.getText() + "','" + TextOpening.getText() + "')";
                    try {
                        Statement stm = conn.createStatement();
                        //pst = conn.prepareStatement(sql);
                     /*
...
if(a==10){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RawMaterials1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                RawMaterials1 dialog = new RawMaterials1(new javax.swing.JFrame(), true);
