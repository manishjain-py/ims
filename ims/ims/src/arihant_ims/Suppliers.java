...
public class Suppliers extends javax.swing.JDialog {
    ...
    private void fill_table(){              
        try {
            pst = conn.prepareStatement("select name as 'Supplier Name',number as 'Contact no.',address as 'Address',email as 'Email-id',narration as 'Narration' from Suppliers order by name");
            rs = pst.executeQuery();
    ...
    private void initComponents() {
        ...
        ButtonAdd.setText("<html><h2>ADD NEW SUPPLIER");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(ButtonEdit, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                    .addComponent(ButtonDelete)
                    .addComponent(ButtonClear, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(ButtonRefresh, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 155, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "SUPPLIERS", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 24), new java.awt.Color(0, 0, 255))); // NOI18N

        jLabel1.setText("<html><h2>Contact number");

        jLabel2.setText("<html><h2>Address");

        jLabel3.setText("<html><h2>Supplier Name");

        jLabel4.setText("<html><h2>Email-id");
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(TextEmail, javax.swing.GroupLayout.DEFAULT_SIZE, 213, Short.MAX_VALUE)
                            .addComponent(TextAddress, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(TextNumber, javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void TableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableMouseClicked
        ...
        String sql = "select * from Suppliers where name='" + row_id + "'";
        try {
    ...
    private void TextSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TextSearchKeyReleased
        try {
            pst = conn.prepareStatement("select * from Suppliers where name='" + TextSearch.getText() + "' COLLATE NOCASE");
            rs = pst.executeQuery();
    ...
    private void ButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonDeleteActionPerformed
        if (click.equals("readyForEdit")) {
            ...
            String sql = "delete from Suppliers where name='" + TextName.getText() + "'";
        ...
        if (click.equals("edit")) {
            if (TextName.isEnabled() == true && TextNumber.isEnabled() == true && TextAddress.isEnabled() == true && TextEmail.isEnabled() == true) {
                if (TextName.getText().equals("")) {
                    PaneLabel = "Supplier Name";
                }
                /*
                 * if (TextNumber.getText().equals("")) { PaneLabel = ""; } if
                 * (TextAddress.getText().equals("")) { PaneLabel = "Item
                 * Reorder quantity"; } if (TextEmail.getText().equals("")) {
                 * PaneLabel = "Item Opening Stock"; }
                 *
                 */
                if (PaneLabel.equals("")) {
                    String sql = "Update Suppliers set name='" + TextName.getText() + "',number='" + TextNumber.getText() + "',address='" + TextAddress.getText() + "',email='" + TextEmail.getText() + "',narration='" + TextAreaNarration.getText() + "' where name='" + editItem + "'";
                    try {
            ...
            if (TextName.isEnabled() == true && TextNumber.isEnabled() == true && TextAddress.isEnabled() == true && TextEmail.isEnabled() == true) {
                ...
                /*
                 * if (TextNumber.getText().equals("")) { PaneLabel = "Item
                 * Cost"; } if (TextAddress.getText().equals("")) { PaneLabel =
                 * "Item Reorder quantity"; } if
                 * (TextEmail.getText().equals("")) { PaneLabel = "Item Opening
                 * Stock"; }
                 *
                 */
                if (PaneLabel.equals("")) {
                    String sql = "Insert into Suppliers values( '" + TextName.getText() + "','" + TextNumber.getText() + "','" + TextAddress.getText() + "','" + TextEmail.getText() + "','" + TextAreaNarration.getText() + "')";
                    try {
                        Statement stm = conn.createStatement();
                        //pst = conn.prepareStatement(sql);
                     /*
...
if(a==10){
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        CreateConnection.DeleteAll("Suppliers", conn);        // TODO add your handling code here:
